      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="w-full lg:w-1/2 mb-8 lg:mb-0">
            <img
              src="https://example.com/tree-plantation.jpg" // Replace with a relevant tree plantation image
              alt="Tree Plantation"
          ...
          <div className="w-full lg:w-1/2 lg:pl-12">
            ...
            <p className="mb-4">
              At [Your Nursery Name], we believe in the power of greenery to transform our environment and lives. Our mission is to contribute to a healthier planet by promoting tree plantation across communities.
            </p>
            <p className="mb-4">
